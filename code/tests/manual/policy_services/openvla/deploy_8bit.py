...
This version includes crucial memory optimizations (8-bit quantization via BitsAndBytes)
...
class OpenVLAServer:
    def __init__(self, openvla_path: Union[str, Path], attn_implementation: Optional[str] = None):
        ...
        self.vla = load_8bit_vla(self.openvla_path, attn_implementation)
...
class DeployConfig:
    ...
    # Keep disabled for initial 8-bit loader debugging; set to "flash_attention_2" after the model loads cleanly.
